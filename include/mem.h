...
#define checked_malloc(size) (internal_checked_malloc((size_t)(size), __LINE__, __FILE__))
#define checked_calloc(nmemb, size) (internal_checked_calloc((size_t)(nmemb), (size_t)(size), __LINE__, __FILE__))
